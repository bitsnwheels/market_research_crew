...
web_scraping_tool = ScrapeWebsiteTool()  #used for static websites 
selenium_scraping_tool = SeleniumScrapingTool()#used for dynamic websites that require JavaScript rendering
